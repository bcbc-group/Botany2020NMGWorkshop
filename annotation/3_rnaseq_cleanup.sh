...
docker run --rm -v /scratch/annotation:/data cyverseuk/mikado mikado serialise --json-conf /data/configuration.yaml --xml /data/mikado.blast.xml.gz --orfs /data/mikado_prepared.fasta.transdecoder.bed --blast_targets /data/uniprot_sprot_plants.fasta

docker run --rm -v /scratch/annotation:/data cyverseuk/mikado mikado pick --json-conf /data/configuration.yaml --subloci_out /data/mikado.subloci.gff3
